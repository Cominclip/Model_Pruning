...
if args.refine:
    ...
    model = vgg.vgg(dataset=args.dataset, depth=args.depth, cfg=checkpoint['cfg'])
...
def save_checkpoint(state, is_best, filepath):
    torch.save(state, os.path.join(filepath, 'finetune_checkpoint_layer1_0.3.pth.tar'))
    if is_best:
        shutil.copyfile(os.path.join(filepath, 'finetune_checkpoint_layer1_0.3.pth.tar'), os.path.join(filepath, 'finetune_model_best_layer1_0.3.pth.tar'))
